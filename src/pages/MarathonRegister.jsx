            ...
            <form onSubmit={handleRegister} className="space-y-4">
               ...
               <div>
                  ...
                  <div className="relative">
                     ...
                     <input
                        ...
                        readOnly
                        className="pl-10 w-full py-2 border rounded-md bg-gray-100 dark:bg-gray-600 text-gray-600 dark:text-gray-300"
                     />
                  </div>
               </div>
               {/* Marathon Title */}
               <div>
                  ...
                  <input
                     ...
                     readOnly
                     className="w-full py-2 border rounded-md bg-gray-100 dark:bg-gray-600 text-gray-600 dark:text-gray-300"
                  />
               </div>
               {/* Marathon Start Date */}
               <div>
               ...
               <div>
                  ...
                  <input
                     ...
                     className="w-full py-2 border rounded-md bg-gray-50 dark:bg-gray-600 text-gray-600 dark:text-gray-300"
                     required
                  />
               </div>
               {/* Last Name */}
               ...
               <div>
                  ...
                  <div className="relative">
                     ...
                     <input
                        ...
                        className="pl-10 w-full py-2 border rounded-md bg-gray-50 dark:bg-gray-600 text-gray-600 dark:text-gray-300"
                        required
                     />
                  </div>
               </div>
               ...
               <div>
                  <button
                     type="submit"
                     className="w-full py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 transition"
                  >
                     Register
                  </button>
               </div>
